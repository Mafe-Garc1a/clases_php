...
<body class="mua">
    ...
    <div class="container text-center mt-4">
        <h1>modifica medico</h1>
        <form action="editarMedico.php" method="post">
            ...
            <tr>
                <td ><h3>n_licencia :</h3></td>
                <td><input type="text" name='n_licencia' value="<?php echo $n_licencia;?>"></td>
                <td ><h3>especialidad :</h3></td>
                <td><input type="text" name='especialidad' value="<?php echo $especialidad;?>"></td>
